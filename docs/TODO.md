...
- Build the first full B67 offline patch bundle: include the scaled VF3 TV
  ...
  entries, gendered outfit icon descriptors, and visible Special Upgrade icon
  descriptors/payloads without distributing a premodified EXE.
...
- In-game test B66/B67 Clothing-store outfit icons: verify female and male outfit
