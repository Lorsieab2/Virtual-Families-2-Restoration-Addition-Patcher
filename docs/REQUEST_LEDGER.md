...
| Mobile Island Events and exact outcomes | Partial | Added event objects/text remain optional. Eighteen events now follow exact mobile firing/outcome evidence. The latest group adds exact Meteorite Falls in Yard 2, Clown Holding Metal Rod, Men in Black at Door, and Hear Strange Sound routes, and preserves Metallic Knocking on Door's dummied-out firing gate. Other outcomes still require one-by-one audits. |
