...
SETTINGS = [
    {
        ...
        "description": "Checks your original game and creates a separate modded copy.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds holiday furniture from the mobile version. These items are decorative for now.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds holiday clothing choices to the Outfit store.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds more clothing choices to the Outfit store. Turn on Holiday outfits too to see the holiday clothing.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds extra furniture from the mobile version. Invisible furniture is controlled by the separate Invisible Furniture options.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds Turtle and Hamster pets.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds Colorful Couches and LDW posters and paintings.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds extra furniture from Virtual Families 3, including several couches and loveseats.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds furniture that is easy to place because it uses normal furniture pictures. Turn this on before placing it.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "After placing the invisible furniture, turn this on to hide it completely.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds Virtual Families 3 TVs and lets them play their special animations. Turn on Patch game executable first.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds more everyday actions and conversations, including sitting, ironing, mending, checking weight, baby care, and extra hobbies. Adult couples with six children can also have private romantic time without pregnancy or arguments.",
        "default": True,
        "category": "main",
    },
    {
        "id": "text_fixes",
        "label": "Text fixes",
        "description": "Fixes small text mistakes, including pet messages and the clean-up message.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Adds 12 holiday collectibles to the yard and six new Collections Chest pages with 72 items total. Includes the Ornamentologist and family collection goals.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds Brokerage Account, Food Club, Health Plan, and Lucky Rock to Special Upgrades.",
        "default": True,
        "category": "main",
    },
    {
        ...
        "description": "Gives adults age 50 and older a small chance to have a baby. Younger adults keep their usual chances. The Next Generation option also becomes available when the oldest family member reaches age 60 and a child is still living.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Allows marriage candidates to be the same sex when the in-game Enable Same-Sex Marriage upgrade is on. Same-sex couples can have private romantic time without pregnancy, refusal, or arguments.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Makes old-age deaths gradually more likely as people grow older. There is no maximum age, and reaching very old ages remains rare.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds mobile-style actions to supported furniture, such as relaxing, reading, studying, napping, eating at picnic tables, using birthday items, and enjoying holiday decorations.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds 15 room makeovers from the mobile version for the kitchen, bathrooms, office, and workshop.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds five Bathroom 2 color makeovers. The artwork was AI-assisted and then manually edited.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Uses mobile-version sounds for supported actions. This option is off by default and still needs player sound testing.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds 25 events from the mobile version, including new emails and choices. Most events include their mobile rewards and actions; two events remain unavailable.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Uses the custom map pictures included with this patcher.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Makes the bottom menu bars see-through.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Makes the store bar see-through.",
        "default": False,
        "category": "optional",
    },
    {
        "id": "white_birds",
        "label": "White Birds",
        "description": "Changes the yard parrots to white birds.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds a scroll bar to the store.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Hides the pictures for workspace upgrades. Turn it off and apply the patch again to restore them.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Makes the purple Decor tab see-through.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds extra picture changes included with this patcher.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds songs from Virtual Families 1 and 2. Turn it off and apply the patch again to restore the original songs.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Fixes small picture problems, including the Super Fridge ice maker position.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds a white glow around objects you can pick up.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "description": "Adds cheat options for coins, food, goals, collections, prices, messes, malfunctions, pregnancies, and marriage. Buying Maid, Gardener, Rockhound Certificate, Anti-Spam, or a house renovation again can remove it.",
        "default": False,
        "category": "optional",
    },
    {
        ...
        "label": "No AI Icons",
        "description": (
            "Requires Cheat Upgrades. Replaces the later Cheat Upgrade pictures with alternate artwork. "
            "Turn it off and apply the patch again to restore the regular pictures."
        ),
        "default": False,
        "category": "optional",
    },
...
SETTING_READINESS = {
    "behavior_patches": {
        ...
        "runtime_ready": False,
        "linked": False,
        "reason": "This option still needs final testing before it can be enabled.",
    },
    "mobile_furniture_behaviors": {
        "status": "pending",
        "runtime_ready": False,
    ...
    "island_events": {
        ...
        "runtime_ready": True,
        "linked": True,
        "reason": "The feature is linked and ready for player testing. Please test its events and confirm there are no crashes.",
    },
    "mobile_renovations": {
        "status": "ready_for_player_qa",
        "runtime_ready": True,
        "linked": True,
        "reason": "The feature is linked and ready for player testing. Please test purchases and save/load.",
    },
    "mobile_sound_assets": {
        "status": "pending",
        "runtime_ready": False,
        "linked": False,
        "reason": "This option still needs final sound testing before it can be enabled.",
    },
    "ai_generated_bathroom2_renovations": {
        "status": "ready_for_player_qa",
        "runtime_ready": True,
        "linked": True,
        "reason": "The feature is linked and ready for player testing. Please test purchases, curtains, and save/load.",
    },
}
    ...
    if include_byte_patches:
        settings.insert(
            0,
            {
                ...
                "description": "Applies the main game changes.",
                "default": True,
                "category": "main",
            },
        )
    settings.append(
        {
            ...
            "description": "Copies the pictures, sounds, and other files needed by the selected options.",
            "default": True,
            "category": "main",
        }
    )
