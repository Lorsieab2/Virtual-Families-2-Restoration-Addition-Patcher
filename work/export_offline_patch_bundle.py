...
SETTINGS = [
    ...
    },
    {
        ...
        "description": "Enables the cheat-only executable overlay. Adds function-grouped money, food, achievement/puzzle/collection, price, and malfunction rows, including Trigger all house malfunctions and Fix all house malfunctions. Trigger makes the Router offline and Fix returns it online; Fix clears all 11 malfunction props without resetting ants. The Dryer lint fire remains a legitimate native random malfunction and requires a Dryer. Price modes affect every purchase routed through the store price calculator; Reset Price Multiplier restores original calculated prices. Rebuying Maid/Gardener fires that worker; rebuying Rockhound Certificate/Anti-Spam removes it. All B150 cheat and reversible-upgrade behavior is absent when this setting is disabled.",
        "default": False,
        "category": "optional",
    },
]
    ...
    lines.extend(
        [
            ...
            *B151_CHANGELOG_LINES,
            ...
            "- Next build source: Adds Cheat Upgrade 0x12E, Complete all Achievements, using native SetComplete for every currently enabled goal row and the trophy icon.",
