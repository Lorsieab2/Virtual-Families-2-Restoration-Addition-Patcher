...
B180_CHANGELOG_LINES = (
    ...
    "- B180 stock-donor furniture: The Invisible Kiddie Pool, Invisible Full-Size Pool, Invisible Hammock, Invisible Yoga Equipment, Exercise Bike, Home Gym System and Ping-Pong Table borrow stock desktop furniture and are not routed through this dispatcher. The HOME GYM SYSTEM DOES NOT WORK: a villager dropped on it does nothing. It is sold in the store and its behaviour is not implemented. The EXERCISE BIKE and the INVISIBLE YOGA EQUIPMENT are unconfirmed -- nobody has reported whether a drop on either does anything. None of these items is claimed to work.",
